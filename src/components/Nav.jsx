                    ...
                    <div className='flex justify-between items-center'>
                        ...
                        <div className='hidden md:block'>
                            <ul className='flex font-medium text-gray-50 space-x-8 text-lg'>
                                <Link><li className='duration-300 hover:text-cyan-500'>Home</li></Link>
                                <Link><li className='duration-300 hover:text-cyan-500'>About</li></Link>
                                <Link><li className='duration-300 hover:text-cyan-500'>Skills</li></Link>
                                <Link><li className='duration-300 hover:text-cyan-500'>Portfolio</li></Link>
                                <Link><li className='duration-300 hover:text-cyan-500'>Contact</li></Link>
                            </ul>
                        </div>
                        {/* Menu bar for mobile */}
